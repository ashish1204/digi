		...
		<div class="row borderBottom">
			...
			<li class="active dropdown">
				<a class="dropdown-toggle buttonlink" 
					...
					data-toggle="dropdown"  style="background-color:#f3f3f3;"><b><button class="btn mobileLabMenu" >Market Trends <span class="caret"></span></button></b>
				</a>
...
<li><a
			...
			<!-- <li >
				<a href="RecommendDevice"class="buttonlink"><b><button class="btn mobileLabMenu" >Device Recommendation</button></b></a>
			</li> -->
			<!-- <li>
			...
			<li class="pull-right">
				<div class="upload">Update Australia Database: </div>
				<form name="userForm" method="post" class="pull-left"
								action="../../mobileLab/deviceSelectionMatrix/uploadFileExcelDataAustralia.obj"
