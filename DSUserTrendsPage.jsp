...
var data = ${chartData};  var appleData = ${appleData};  var LGData = ${LGData}; 
var googleData = ${googleData};  var samData = ${samData}; var motoData=${motoData};
...
<body>
	...
	<ul class="nav nav-tabs marginLeft15px marginTop15px">
				<li  class="dropdown"><a class="dropdown-toggle buttonlink" 
					data-toggle="dropdown"><b>Market
								Trends <span class="caret"></span></b></a>
			...
			<li class="active dropdown">
				<a class="dropdown-toggle buttonlink"
					...
					data-toggle="dropdown"  style="background-color:#f3f3f3;"><b><button class="btn mobileLabMenu" >User Trends <span class="caret"></span></button></b>
				</a>
				<ul class="dropdown-menu">
					<li class="active"><a
...
<li><a
			...
			<!-- <li >
				<a href="DSselectDevices.jsp" class="buttonlink"><b><button class="btn mobileLabMenu" >Device Recommendation</button></b></a>
			</li> -->
			<!-- <li>
			...
			<li class="pull-right">
				<div class="upload">Update User Database: </div>
				
				<form name="userForm" method="post" class="pull-left"
								action="../../mobileLab/deviceSelectionMatrix/uploadFileExcelDataUser.obj"
								enctype="multipart/form-data" onSubmit="return GoEmpty(this);">
				<input type="file" class="btn btn-primary" id="recentData" name="recentData" >
