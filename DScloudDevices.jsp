...
<body>
 ...
 <li ><a
			...
			<!-- 	<div class="col-sm-8 col-md-10 verticalLine"> -->
					...
					<div class="font24px txtCenter"><label >Available Cloud Devices</label></div>
									...
									<table id="table" align="center" class="table table-hover table-striped table-bordered table-responsive"
										...
										<tbody>
											...
											<c:if test="${deviceList.displayStatus == 'Available'}">
                                               	...
                                               	<td align="center"><a href="reserveDevice?deviceId=${deviceList.deviceID}&deviceName=${deviceList.deviceName}"><button class="btn btn-primary" style ="background-color: #50CF4D" id="but${deviceList.deviceID}" disabled="disabled"><b>Reserve</b></button></a></td>
                                               </c:if>
                                               ...
                                               <c:if test="${deviceList.displayStatus == 'In Use'}">
			                                        ...
			                                        <%-- <td align="center"><a href="../../mobileLab/deviceSelectionMatrix/DSfinalSelection?deviceId=${deviceList.deviceID}"><button class="btn btn-primary" id="but${deviceList.deviceID}" disabled="disabled">Reserve</button></a></td>	 --%>
                                               	<td align="center"><a href="releaseDevice?deviceId=${deviceList.deviceID}&deviceName=${deviceList.deviceName}"><button class="btn btn-primary" style ="background-color: #FDB45C"; id="but${deviceList.deviceID}" disabled="disabled"><b>Release</b></button></a></td>
                                               </c:if>
