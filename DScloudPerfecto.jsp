...
<li ><a
				...
				<li ><a href="DSselectDevices.jsp" class="buttonlink"><b><button class="btn mobileLabMenu">Device Recommendation</button></b></a></li>
			...
			<!-- 	<div class="col-sm-8 col-md-10 verticalLine"> -->
					...
					<div class="font24px txtCenter"><label >Available Cloud Devices1</label></div>
		...
		<c:if test="${not empty message }">
			<h3 class="successMsg">${message }</h3>
								...
								<c:if test="${ not empty perfectoDevice }">
									...
									<table id="table" align="center" class="table table-hover table-striped table-bordered table-responsive"
										cellpadding="0" cellspacing="0" data-filter="true" data-input="#filterTable-input">
										<thead>
											<tr class="tableHead">
										...
										<tbody>
											...
											<tr>
													<td align="center"><input type="checkbox"  value="${perfectoDevice.deviceId}" id="${perfectoDevice.deviceId}" onchange="getButton(this.id);"/></td>
													<td align="left"><c:out
															value="${perfectoDevice.deviceName}" /></td>
													<td align="left"><c:out value="${perfectoDevice.os}" /></td>
													<td align="left"><c:out
															value="${perfectoDevice.version}" /></td>
													<td align="left"><c:out
															value="${perfectoDevice.status}" /></td>
													
			                                    <c:if test="${perfectoDevice.reservation == 'false'}">    
                                               	<td align="center"><a href="reservePerfectoDevice?deviceId=${perfectoDevice.deviceId}"><button class="btn btn-primary" style ="background-color: #50CF4D" id="but${perfectoDevice.deviceId}" disabled="disabled"><b>Reserve</b></button></a></td>
                                            	</c:if>
                                               ...
                                               <c:if test="${perfectoDevice.reservation == 'true'}">    
                                               	<td align="center"><a href="releasePerfectoDevice1?deviceId=${perfectoDevice.deviceId}&reservationId=${perfectoDevice.reservationId}"><button class="btn btn-primary" style ="background-color: #FDB45C"; id="but${perfectoDevice.deviceId}" disabled="disabled"><b>Release</b></button></a></td>
                                               </c:if>	
