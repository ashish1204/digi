  	...
  	<ul class="nav nav-tabs marginLeft15px">
				<li  class="dropdown"><a class="dropdown-toggle buttonlink"
					data-toggle="dropdown"><b><button class="btn mobileLabMenu" >Market
								Trends  <span class="caret"></span></button></b></a>
...
<li ><a
				...
				<li class="active"><a href="RecommendDevice" class="buttonlink"><b><button class="btn mobileLabMenu" >Device Recommendation</button></b></a></li>
		...
		<div class="top-bar">
			<a href=""></a>
			<div class="font24px txtCenter"><label >Select Device Recommendation Options</label></div>
	...
	<div class="row col-sm-12">
		...
		<div class="col-sm-8">
			<form id="formname" class="form-horizontal" name="formname" method="post"
					action="../../mobileLab/deviceSelectionMatrix/DSfinalSelection"
					onSubmit="return FieldsEmpty(this);">
				<div class="form-group">
					<label for="run_name" class="col-sm-2 control-label">Select OS :</label>
					<div class="col-sm-8">
				...
				<div class="form-group">
					<label for="project_name" class="col-sm-2 control-label">Select Version : </label>
					<div class="col-sm-8">
				...
				<div class="form-group">
					<label for="build_id" class="col-sm-2 control-label">Select Option : </label>
					<div class="col-sm-8">
						<select class="form-control" name="optionnm" id="optionnm">
							<option value="">Select Option</option>
							<option value="Only Selected Version">Only Selected Version</option>
							<option value="Selected and Higher Versions">Selected and Higher Versions</option>
						</select>
					</div>
				</div>
				<div class="form-group">
					<label for="run_name" class="col-sm-2 control-label">No of Devices :</label>
					<div class="col-sm-8">
				...
				<div class="form-group">
					...
					<div class="col-sm-2 col-sm-offset-5">
						<a href="#"> <input type="submit" name="ds" value="Devices" class="btn btn-primary"></a>
					</div>
				</div>
			</form>
		</div>
	...
	<div class="marginTop15px"></div>
		<div class="col-sm-2"></div>
		<div class="col-sm-8">
			<label>Selected OS : </label>${category}<br>
			<label>Selected Version : </label>${subcategory}<br>
			<label>Selected Option : </label>${optionnm}<br>
			<label>No. of Devices : </label>${n}
		</div>
		<div class="col-sm-2"></div>
	</div>
