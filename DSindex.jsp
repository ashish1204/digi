...
<c:if test="${country == 'Global' }">
 ...
 <c:if test="${country == 'User' }">
	<jsp:forward page="../../mobileLab/deviceSelectionMatrix/DSUserTrendsPage"></jsp:forward>
</c:if>  
<c:if test="${country == 'Australia' }">
	<jsp:forward page="../../mobileLab/deviceSelectionMatrix/DSHomeAustraliaPage"></jsp:forward>
</c:if>  
</body>
</html>