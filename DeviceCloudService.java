...
public class DeviceCloudService implements IDeviceCloudService {
	...
	public List<Market> getMarkets() {
		...
		return iDeviceCloudDao.getMarketsDao();
	}

	//DEVICE TRENDS

	@Override
	public List<OemDistribution> getOEMDistribution(int id) {
		
		return iDeviceCloudDao.getOEMDistributionDao(id);
	}


	@Override
	public List<OsDistribution> getOsDistribution(int id) {
		
		return iDeviceCloudDao.getOsDistributionDao(id);
	}

	

	@Override
	public List<AndroidDistribution> getAndroidDistribution() {
		
		return iDeviceCloudDao.getAndroidDistributionDao();
	}

	
	@Override
	public List<IosDistribution> getIosDistribution() {
		
		return iDeviceCloudDao.getIosDistributionDao();
	}
...
//BROWSER TRENDS
	...
	@Override
	public List<MobileBrowserDistribution> getMobileBrowserDistribution(int id) {
	
		return iDeviceCloudDao.getMobileBrowserDistributionDao(id);
	}



	@Override
	public List<DesktopBrowserDistribution> getDesktopBrowserDistribution(int id) {
		
		return iDeviceCloudDao.getDesktopBrowserDistributionDao(id);
	}

	
	@Override
	public List<MobileBrowserVersionDistribution> getMobileBrowserVersionDistribution(String name) {
		
		return iDeviceCloudDao.getMobileBrowserVersionDistributionDao(name);
	}

	@Override
	public List<DesktopBrowserVersionDistribution> getDesktopBrowserVersionDistribution(String name) {
		
		return iDeviceCloudDao.getDesktopBrowserVersionDistributionDao(name);
	}
	...
	@Override
	public List<UserOemDistribution> getUserOemDistribution() {
	
		return iDeviceCloudDao.getUserOemDistributionDao();
	}

	@Override
	public List<UserOsDistribution> getUserOsDistribution() {
		
		return  iDeviceCloudDao.getUserOsDistributionDao();
	}

	
	////UPDATE DEVICE TRENDS
	@Override
	public String updateDeviceTrends(List<OemDistribution> listOEM,List<OsDistribution>listOS) {
	
		return iDeviceCloudDao.updateDeviceTrendsDao(listOEM,listOS);
	}
	
	//UPDATE BROWSER TRENDS
	@Override
	public String updateBrowserTrends(List<MobileBrowserDistribution> ListMobileBrowser,
			List<DesktopBrowserDistribution> ListDesktopBrowser) {
		return iDeviceCloudDao.updateBrowserTrendsDao(ListMobileBrowser,ListDesktopBrowser);
	...
	@Override
	public String updateUserTrends(List<UserOemDistribution> listOEM, List<UserOsDistribution> listOS) {
		return iDeviceCloudDao.updateUserTrendsDao(listOEM,listOS);
	...
	@Override
	public boolean truncateBrowserMarketshare() {
		// TODO Auto-generated method stub
				return iDeviceCloudDao.truncateBrowserMarketshareDao();
	}



	@Override
	public boolean insertBrowserMarketshare(String browserName, String month, double value) {
		return iDeviceCloudDao.insertBrowserMarketshareDao(browserName, month, value);
	}

	

	@Override
	public boolean insertBrowserDesktopMarketshare(String browserDeskName, String month, double value) {
		return iDeviceCloudDao.insertBrowserDesktopMarketshareDao(browserDeskName, month, value);

	}
	////////////UPDATE BROWSER US MARKETSHARE
	
	@Override
	public boolean truncateBrowserUSMarketshare() {

		return iDeviceCloudDao.truncateBrowserUSMarketshareDao();

	}

	@Override
	public boolean insertBrowserUSMarketshare(String browserName, String month, double value) {

		return iDeviceCloudDao.insertBrowserUSMarketshareDao(browserName, month, value);
	}


	@Override
	public boolean insertBrowserUSDesktopMarketshare(String browserDeskName, String month, double value) {
		return iDeviceCloudDao.insertBrowserUSDesktopMarketshareDao(browserDeskName, month, value);
	...
	@Override
	public boolean truncateBrowserUKMarketshare() {
		return iDeviceCloudDao.truncateBrowserUKMarketshareDao();
	}

	@Override
	public boolean insertBrowserUKMarketshare(String browserName, String month, double value) {
		return iDeviceCloudDao.insertBrowserUKMarketshareDao(browserName, month, value);
	}


	@Override
	public boolean insertBrowserUKDesktopMarketshare(String browserDeskName, String month, double value) {
		return iDeviceCloudDao.insertBrowserUKDesktopMarketshareDao(browserDeskName, month, value);
	...
	public List<OS_Details> OSDeviceData() {
		// TODO Auto-generated method stub
		return iDeviceCloudDao.OSDeviceData();
	}

	@Override
	public List<Android_Rates> AndroidRatesData() {
		// TODO Auto-generated method stub
		return iDeviceCloudDao.AndroidRatesData();
	}

	@Override
	public List<iOS_Rates> iOSRatesData() {
		// TODO Auto-generated method stub
		return iDeviceCloudDao.iOSRatesData();
	}
	@Override
	public List<Android_Rates> AndroidRatesDataUser() {
		// TODO Auto-generated method stub
		return iDeviceCloudDao.AndroidRatesDataUser();
	}

	@Override
	public List<iOS_Rates> iOSRatesDataUser() {
		// TODO Auto-generated method stub
		return iDeviceCloudDao.iOSRatesDataUser();
	}
	...
	public List<OS_Names> DisplayOS_Names() {
		// TODO Auto-generated method stub
		return iDeviceCloudDao.DisplayOS_Names();
	}
	...
	public boolean InsertVendor_MarketShare(String vend_names, String vend_namesm, double data_values) {
		// TODO Auto-generated method stub
		return iDeviceCloudDao.InsertVendor_MarketShare(vend_names,vend_namesm,data_values);
	}
	...
	public boolean InsertOS_MarketShare(String os_names, String os_namesm, double data_values) {
		// TODO Auto-generated method stub
		return iDeviceCloudDao.InsertOS_MarketShare(os_names,os_namesm,data_values);
	}
	...
	public boolean Insert_BasicDeviceData(int vend_id, int OS_id, int ver_id,
		...
		// TODO Auto-generated method stub
		return iDeviceCloudDao.Insert_BasicDeviceData(vend_id, OS_id, ver_id, ver_nm, model_nm, tp, resolution);
	}
	...
	public List<OS_Details> OSUKDeviceData() {
		// TODO Auto-generated method stub
		return iDeviceCloudDao.OSUKDeviceData();
	}
	@Override
	public List<OS_Details> OSGlobalDeviceData() {
		// TODO Auto-generated method stub
		return iDeviceCloudDao.OSGlobalDeviceData();
	}
	@Override
	public List<OS_Details> OSUserDeviceData() {
		// TODO Auto-generated method stub
		return iDeviceCloudDao.OSUserDeviceData();
	}
	@Override
	...
	public boolean InsertUKVendor_MarketShare(String vend_names,
		...
		// TODO Auto-generated method stub
		return iDeviceCloudDao.InsertUKVendor_MarketShare(vend_names, vend_namesm, data_values);
	}
	@Override
	public boolean InsertUserVendor_MarketShare(String vend_names,
			String vend_namesm, double data_values) {
		// TODO Auto-generated method stub
		return iDeviceCloudDao.InsertUserVendor_MarketShare(vend_names, vend_namesm, data_values);
	}
	@Override
	public boolean InsertGlobalVendor_MarketShare(String vend_names,
			String vend_namesm, double data_values) {
		// TODO Auto-generated method stub
		return iDeviceCloudDao.InsertGlobalVendor_MarketShare(vend_names, vend_namesm, data_values);
	}
	...
	public boolean InsertUKOS_MarketShare(String os_names, String os_namesm,
			double data_values) {
		// TODO Auto-generated method stub
		return iDeviceCloudDao.InsertUKOS_MarketShare(os_names, os_namesm, data_values);
	}
	@Override
	public boolean InsertUserOS_MarketShare(String os_names, String os_namesm,
			double data_values) {
		// TODO Auto-generated method stub
		return iDeviceCloudDao.InsertUserOS_MarketShare(os_names, os_namesm, data_values);
	}
	@Override
	public boolean InsertGlobalOS_MarketShare(String os_names, String os_namesm,
			double data_values) {
		// TODO Auto-generated method stub
		return iDeviceCloudDao.InsertGlobalOS_MarketShare(os_names, os_namesm, data_values);
	}
	...
	//for perfecto
		...
		public int addDevices(int id , String vendor, String device_id, String name ,String version , String os , String status , String reservation , String reservation_id,String udid,String deviceCategory,String location,String resolution) {
			return iDeviceCloudDao.addDevices(id , vendor, device_id, name ,version , os ,status ,reservation ,reservation_id,udid,deviceCategory,location,resolution);
		...
		public int updateReservationtime(String deviceId , String reservation_time) {
			return iDeviceCloudDao.updateReservationtime(deviceId, reservation_time);
		}
		...
		public Reserve getCheckMail() {
			...
			return iDeviceCloudDao.getCheckMail();
		}
