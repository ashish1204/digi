...
public interface IDeviceCloudService {
	...
	List<OS_Details> OSAustraliaDeviceData();
	boolean TruncateAustraliaVendor_MarketShare();
	boolean InsertAustraliaVendor_MarketShare(String string, String string2,
			double d);
	Boolean InsertAustraliaOS_MarketShare(String os_names, String os_namesm,
			double data_values);
