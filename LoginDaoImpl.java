...
public class LoginDaoImpl implements ILoginDao {
	...
	public User getuserDetails(int userid) {
		...
		try {
			...
			String sql="SELECT u.userid,u.firstname,u.lastname,u.username,u.phonenumber,u.email,r.rolename,u.projectid from users u, roles r where r.roleid=u.roleid and u.status=? and userid=?";
