...
public class PerfectoAPI1 {
		...
		//	System.out.println(new PerfectoAPI1().getDeviceList("anuja.saraf@capgemini.com", "Digi2017"));
		...
		public JSONArray getDeviceList(String username , String password){
			String URL ="https://partners.perfectomobile.com/services/handsets?operation=list&user="+username+"&password="+password;
			String xmlString=new RESTAPICall().callRESTAPI(URL);
		//System.out.println("JSON STRINg"+xmlString);
		...
		public  String reserveDevice(String deviceId){
			String username="anuja.saraf@capgemini.com";
			String password="Digi2017";
			// https://partners.perfectomobile.com/services/reservations?operation=create&user=anuja.saraf@capgemini.com&password=Digi2017&resourceIds=30EDD233,0E6FBDEEF6C5EECEF71F66904FC4EFDA3F803682&startTime=-1&endTime=1481710827000
			long unixTime = System.currentTimeMillis() + ((90 * 60)*1000);
