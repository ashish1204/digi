...
public class Reservation {
	...
	public Reservation(String reservationid, String devicecatalogid,
			String reservationsessionid, String starttime, String endtime,
			String status, String creationtime, String createdby,
			String modifiedby, String modifiedtime, String message,
			String approvalStatus, String devicename) {
		super();
	...
	public String toString() {
		return "Reservation [reservationid=" + reservationid
				...
				+ ", modifiedtime=" + modifiedtime + ", message=" + message
				+ ", approvalStatus=" + approvalStatus + ", devicename="
				+ devicename + "]";
	}
