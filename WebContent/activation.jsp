	...
	<div>
		...
		<div class="container">
			<div class="col-sm-8 col-sm-offset-2 marginTop15px">
				...
				<form action="activate" onSubmit="return validate();" role="form"
					method="post">
					<h2 class="form-signin-heading panelContent">User Activation</h2>
					<div class="form-group ">
						<label for="email_id">Email(User Name)</label> <input type="text"
							class="form-control" id="userName" name="userName" required />
					</div>

					<div class="form-group">
						<label for="user_pwd">Password</label> <input type="password"
							name="password" class="form-control" required id="password" />
					</div>

					<div class="form-group">
						<label for="user_pwd">New Password</label> <input type="password"
							name="userPassword" class="form-control" required
							id="userPassword" />
					</div>
					<div class="form-group">
						<label for="user_pwd">Confirm Password</label> <input
							type="password" name="repeatPassword" class="form-control"
							required id="repeatPassword" />
					</div>


					<button class="btn btn-primary center-block btn-block"
