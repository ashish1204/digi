...
<div class="page-container">
	<div class="page-content">
		...
		<script type="text/javascript"
			src="${pageContext.request.contextPath}/js/plugins/jquery/jquery-ui.min.js"></script>
		<script type="text/javascript"
		...
		<script type="text/javascript"
			src="${pageContext.request.contextPath}/js/plugins/rickshaw/d3.v3.js"></script>
		<script type="text/javascript"
		...
		<script type="text/javascript"
			src="${pageContext.request.contextPath}/js/plugins/bootstrap/bootstrap-timepicker.min.js"></script>
		<script type="text/javascript"
			src="${pageContext.request.contextPath}/js/plugins/owl/owl.carousel.min.js"></script>
		...
		<script type="text/javascript"
			src="${pageContext.request.contextPath}/js/demo_dashboard.js"></script>
		<!-- END TEMPLATE -->
		<!-- END SCRIPTS -->
		...
		<div class="" style="margin-top: 0px; padding-top: 0px">
			...
			<div class="">
				...
				<ul class="x-navigation x-navigation-horizontal x-navigation-panel">
					...
					<li class="xn-logo"><img class="capgeminiLoginLogo"
						src="${pageContext.request.contextPath}/styles/images/cg.png"
						onclick="goToLandingPage()"></li>
					...
					<c:if test="${sessionScope.rolename == 'ADMIN'}">
						<li class="xn-openable"><a href="#"><span
								class="fa fa-files-o"></span> <span class="xn-text">Admin
									Operations</span></a>
							<ul>
								<li><a href="#" onclick="changeViewFromNav('Projects')"><span
					...
					<li class="xn-icon-button pull-right" style="padding-top: 15px">
						<h4 style="color: white;">
							${sessionScope.userName } <a href="#" class="mb-control"
								data-box="#mb-signout"><span class="fa fa-sign-out"></span></a>
						</h4>
					</li>
					<!-- END SEARCH -->
