...
<div class="page-sidebar">
	...
	<ul class="x-navigation">
		<li class="xn-logo"><a href="./" class="x-navigation-control"><img
				class="capgeminiLogo"
				src="${pageContext.request.contextPath}/styles/images/capgemini.png"></a></li>
		...
		<li class="xn-openable"><a href="#"><span
			...
			<ul>
				...
				<li class="xn-openable"><a href="#"><span
					...
					<ul>
						<li><a href="#"
							onclick="changeViewFromNav('mobileAppsTesting')">Mobile Apps
								Testing </a></li>
						<li><a href="#"
		...
		<li class="xn-openable"><a href="#"><span
				class="fa fa-files-o"></span> <span class="xn-text">Dashboard
					& Monitoring</span></a>
			<ul>
				<li><a href="#" onclick="changeViewFromNav('EnvironmentSetUp')"><span
