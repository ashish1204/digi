...
<div data-ng-controller="">
	<nav
		...
		<div class="container-fluid col-sm-11 col-md-11">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav nav-pills nav-justified">
					<li class="dropdown with-dropdown"><a
						class="dropdown-toggle whiteTextColor" data-toggle="dropdown">
							Digi Smart Lab<span class="caret"></span>
					</a>
						<div class="dropdown-content dropdown-menu show marginLeft80px">
							<div>
								<ul class="list-unstyled">
									<li><a href="#" onclick="changeViewFromNav('mobile')">
											<%-- <img src="${pageContext.request.contextPath}/styles/images/tooltip/mobileLab_tooltip.png" class="navImgResolution" /> --%>
											Mobile Lab
									</a></li>
									<li><a href="#" onclick="changeViewFromNav('cloud')">
											<%-- <img src="${pageContext.request.contextPath}/styles/images/tooltip/cloud_tooltip.png" class="navImgResolution" /> --%>
											Cloud Testing
									</a></li>
									<li><a href="#" onclick="changeViewFromNav('iot')">
											<%-- <img src="${pageContext.request.contextPath}/styles/images/tooltip/iot_tooltip.png" class="navImgResolution" /> --%>
											IOT
									</a></li>
									<li><a href="#"
										onclick="changeViewFromNav('paymentDevice')">
											<%-- <img src="${pageContext.request.contextPath}/styles/images/tooltip/paymentDevice_tooltip.png" class="navImgResolution" /> --%>
											Payment Device
									</a></li>
								</ul>
							</div>
						...
						<div class="dropdown-content dropdown-menu show marginLeft80px">
							...
							<div>
								<ul class="list-unstyled">
									...
									<li><a href="#"
										onclick="changeViewFromNav('userExperienceAnalytics')">
											User Experience Analytics </a></li>
									<li><a href="#"
										onclick="changeViewFromNav('sentimentAnalytics')">
											Sentiment Analytics </a></li>
									<li><a href="#"
										onclick="changeViewFromNav('accessibilityTesting')">
											Accessibility Testing</a></li>
									<li class="divider"></li>
									...
									<li><a href="#"
										onclick="changeViewFromNav('mobileCertificationTesting')">
											Mobile Certification Testing </a></li>
									<li><a href="#"
										onclick="changeViewFromNav('digitalPaymentTesting')">
											Digital Payments Testing</a></li>
									<li><a href="#"
										onclick="changeViewFromNav('internetOfThing')"> IOT
											Testing</a></li>
									<li class="divider"></li>
									<li class="greybg">Digital NFT</li>
									<li><a href="#"
										onclick="changeViewFromNav('performanceTesting')">
					...
					<li class="dropdown with-dropdown"><a
						...
						<div class="dropdown-content dropdown-menu show marginLeft80px">
							<div>
								<ul class="list-unstyled">
									<li><a href="#"
										onclick="changeViewFromNav('bddAutomation')">
											<%-- <img src="${pageContext.request.contextPath}/styles/images/tooltip/bddAutomation_tooltip.png" class="navImgResolution" /> --%>
											BDD Automation
									</a></li>
									<li><a href="#"
										onclick="changeViewFromNav('serviceAutomation')">
											<%-- <img src="${pageContext.request.contextPath}/styles/images/tooltip/serviceAutomation_tooltip.png" class="navImgResolution" /> --%>
											Service Automation
									</a></li>
									<li><a href="#"
										onclick="changeViewFromNav('crossBrowser')">
											<%-- <img src="${pageContext.request.contextPath}/styles/images/tooltip/crossBrowserAutomation_tooltip.png" class="navImgResolution" /> --%>
											Cross Browser Automation
									</a></li>
									<li><a href="#"
										onclick="changeViewFromNav('functionalAutomation')">
											<%-- <img src="${pageContext.request.contextPath}/styles/images/tooltip/functional_Automation_tooltip.png" class="navImgResolution" /> --%>
											Usability Automation
									</a></li>
									<li><a href="#"
										onclick="changeViewFromNav('uiAutomation')">
											<%-- <img src="${pageContext.request.contextPath}/styles/images/tooltip/uiAutomation_tooltip.png" class="navImgResolution" /> --%>
											UI Automation
									</a></li>
								</ul>
							</div>
					...
					<li class="dropdown with-dropdown"><a
						...
						<div class="dropdown-content dropdown-menu show marginLeft80px">
							<div>
								<ul class="list-unstyled">
									<li><a href="#"
										onclick="changeViewFromNav('EnvironmentSetUp')">Environment
											Set Up</a></li>
									...
									<li><a href="#" onclick="changeViewFromNav('dashboard')">Dashboard</a>
									</li>
									<%-- <li>
									...
									<li><a href="#"
										onclick="changeViewFromNav('predictiveAnalysis')">
											<%-- <img src="${pageContext.request.contextPath}/styles/images/tooltip/predictive_tooltip.png" class="navImgResolution" /> --%>
											Predictive Analysis
									</a></li>
		...
		<div class="col-sm-1 col-md-1 marginTop5px" id="result">
			<button onclick="startConverting();" class="btn btn-primary ">
