				...
				<div class="panel panel-info">
					...
					<div class="panel-body">
						...
						<c:if test="${toolName eq 'CGAF_Usability' }">
							<form:form class="form-horizontal" action="editRunCafeSeetest"
								method="POST" id="editRunCafeSeetest" modelAttribute="editRun"
								title="editRunCafeSeetest" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<label class="radio-inline"> <input
											...
											for="ScheduledAt"> Delay By</label>

											<div class="input-append">
												<form:input path="scheduledtime" class="my-date-picker"
													name="selectedDate" id="selectedDate" type="text" />
												<span class="add-on"> <i
													data-date-icon="icon-calendar"></i>
												</span> <span id="timeError"></span>
											</div>
										</label>
