			...
			<div class="row">
				<div class="qaLabMobileLab paddingBottom15px">
					<div class="col-sm-4 paddingTop50px ">
						<img src="../styles/images/tooltip/bddAutomation_tooltip.png"
							class="mobileLabImg" />
					</div>
					<div class="col-sm-8 panelContent marginTop15px">
						...
						<ul class="text-left integratedQALabPanelListDataContent">
							...
							<li>Convert your user stories into automation scripts with
								single click.</li>
							<li>Validate your mobile or web applications across multiple
								devices and browsers using lab.</li>
						</ul>
						<button class="btn btn-info marginTop15px bgWhite blackTextColor"
							onclick="callCloud()">Continue</button>
					</div>
				</div>
			</div>
		</div>
		<div class="container">
			<div class="row">
				<div class="qaLabCloudTesting paddingTop50px paddingBottom15px">
					<div class="col-sm-4">
						<img src="../styles/images/tooltip/serviceAutomation_tooltip.png"
							class="mobileLabImg" />
					</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="qaLabIOT paddingTop50px paddingBottom15px">
					<div class="col-sm-4">
						<img
							src="../styles/images/tooltip/crossBrowserAutomation_tooltip.png"
							class="mobileLabImg" />
					</div>
					...
					<div class="col-sm-8 panelContent text-left">
						...
						<ul class="text-left integratedQALabPanelListDataContent">
							<li>Test your sites on multiple browsers and devices as your
								customers use.</li>
							<li>Script less record and play. No requirement of
								specialized automation skills.</li>
							<li>Use real devices, browsers and perform function, UI
								validations.</li>
						</ul>
						<button
							class="btn btn-info marginTop15px bgWhite blackTextColor opacityPt5">Continue</button>
		...
		<div class="container">
			<div class="row">
				...
				<div class="qaLabPaymentDevice paddingTop50px paddingBottom15px">
					<div class="col-sm-4">
						<img
							src="../styles/images/tooltip/functional_Automation_tooltip.png"
							class="mobileLabImg" />
					</div>
					...
					<div class="col-sm-8 panelContent text-left">
						...
						<ul class="text-left integratedQALabPanelListDataContent">
							<li>Perform lifecycle automation for multichannel
								applications.</li>
							<li>System Integration Test automation, Automation for UAT
								and Static testing.</li>
		...
		<div class="container">
			<div class="row">
				<div class="qaLabMobileLab paddingTop50px paddingBottom15px">
					<div class="col-sm-4">
						<img src="../styles/images/tooltip/uiAutomation_tooltip.png"
							class="mobileLabImg" />
					</div>
