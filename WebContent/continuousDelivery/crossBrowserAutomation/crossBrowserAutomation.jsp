					...
					<div class="marginTop65px">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<ul>
									<li>Automated test execution on multiple Browser
										Combinations which includes Desktop and Mobile Browsers</li>
									<li>Test your web applications on grids which has both
										Desktop and Mobile Browser Components</li>
									<li>Cross Browser Automation framework integrated with
										tools such as Perfecto, Appium and BrowserStack</li>
								</ul>
							</div>
						</div>
						...
						<div class="marginTop15px">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<ul>
										<li>Availability of Cross Browser Automation Framework
											with recorder</li>
										<li>Installation/ Availability of Appropriate Device
											grids.</li>
								...
								<div class="panel-body">
									<ol>
										<li>Login to DigiAssure Server with appropriate
											Credentials</li>
										<li>For Cross Browser Automation, go to "Continuous
											Delivery->Cross Browser Automation"</li>
										<li>Download the "OPTIK" framework recorder from
											DigiAssure for script recording</li>
										<li>Create the scripts on the recorder as per the
										...
										<li>Upload the recorded scripts to DigiAssure for
											executions</li>
										<li>Once execution is completed, Download the report from
