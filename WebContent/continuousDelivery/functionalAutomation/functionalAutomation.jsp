...
<body
	onload="changeAccordion('functionalAutomation','continuousDelivery')">
					...
					<div class="marginTop65px">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<ul>
									<li>DigiAssure solution provides frameworks to automate
										functional requirements of application and allows continuous
										integration environment using Jenkins</li>
									<li>Automation support is available for different digital
										platforms i.e. mobile, wearable’s and desktop</li>
									<li>Functional automation environment support extends to
										various cloud solutions i.e. Perfecto, Seetest and Appium</li>
								</ul>
							</div>
						</div>
								...
								<div class="panel-body">
									<ul>
										<li>Functional automation test plan should be ready and
											tester should get test cases segregated for automation</li>
										...
										<li>Functional automation test plan should be ready and
											...
											Contact Us <a href="" onclick="sendMail()"><i
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<ol>
										...
										<li>Upload required files back to framework execution
											console section on DigiAssure</li>
								...
								<div class="panel-body">
									<ul>
										<li><i class="glyphicon glyphicon-file"> </i><a
											href='${pageContext.request.contextPath}/integratedQALabs/mobileLab/downloadManual?toolName=FunctionalSeetestManual'><b>CGAF
													Seetest User Manual</b></a></li>
										<li><i class="glyphicon glyphicon-file"> </i><a
											href='${pageContext.request.contextPath}/integratedQALabs/mobileLab/downloadManual?toolName=OPTIKUserManual'><b>OPTIK
													User Manual</b></a></li>
