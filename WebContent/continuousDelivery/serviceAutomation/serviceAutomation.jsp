				...
				<div class="col-sm-8 col-md-9 verticalLine">
					<div class="marginTop65px">
						<div class="page-header">
							<h1 class="greyTextColor">Service Automation - TWIST (Coming
								Soon)</h1>
						</div>
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<ul>
									...
									<li>Test your Web & Mobile applications even when the UI
										is not available. The framework provides validation from
										backend services or stubs</li>
								...
								<div class="panel-body">
									<ol>
										<li>Login to DigiAssure Server with appropriate
											Credentials</li>
										<li>For Services Automation, go to "Continuous
											Delivery->Services Automation"</li>
										<li>Download the "TWIST" framework from DigiAssure for
											script recording</li>
										<li>Create the scripts on the framework as per the
											application functionality and request formats</li>
