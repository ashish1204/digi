...
<body onload="changeAccordion('dashboard','dashboardAndMonitoring')">
				...
				<div class="col-sm-8 col-md-9 verticalLine">
					<div class="marginTop65px">
						<div class="page-header">
							<h1 class="greyTextColor">Dashboard - Need to change the
								content</h1>
						</div>
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<ol>
										...
										<li>6. For automation testing – After step 3 Continue
											from “Continuous Delivery-> "Functional Testing"</li>
										<li>7. Manage your devices/Wearables on Cloud using the
											provided login. If you do not have the credentials. Contact
											us <a href="" onclick="sendMail()"><i
												class="glyphicon glyphicon-envelope"></i></a>
										</li>
									</ol>
								</div>
						...
						<span class="marginLeft20px"> <a
							href='${pageContext.request.contextPath}/console/runHome?toolName=Cafe_Seetest'><button
									class="btn btn-primary">Mobile Test Lab</button></a>
						</span>
