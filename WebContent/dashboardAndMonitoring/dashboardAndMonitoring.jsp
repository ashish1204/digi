			...
			<div class="row">
				<div class="dashboard paddingBottom15px">
					<div class="col-sm-4 paddingTop50px ">
						<img src="../styles/images/tooltip/dashboard_tooltip.png"
							class="mobileLabImg" />
					</div>
		...
		<div class="container">
			<div class="row">
				<div class="testCoverage paddingTop50px paddingBottom15px">
					<div class="col-sm-4">
						<img src="../styles/images/tooltip/testCoverage_tooltip.png"
							class="mobileLabImg" />
					</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="predictiveAnalysis paddingTop50px paddingBottom15px">
					<div class="col-sm-4">
						<img src="../styles/images/tooltip/predictive_tooltip.png"
							class="mobileLabImg" />
					</div>
