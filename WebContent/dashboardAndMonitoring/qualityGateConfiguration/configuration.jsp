...
<body
	onload="changeAccordion('environmentSetup','dashboardAndMonitoring')">
	<div>
			...
			<div class="row">
				<div class="col-sm-12 col-md-12">
					...
					<div class="page-header">
						...
						<h1 class="greyTextColor txtCenter">Environment SetUp</h1>
					</div>
				</div>
				<form class="form-horizontal" action="">
					...
					<div class="panel-group accordion accordion-dc">
						...
						<div class="panel panel-info">
							<div class="panel-heading">
								<h4 class="panel-title panelTitle">
									<a id="menu-toggle" data-toggle="collapse"
										href="#codemanagement"
										class="headingfont-size heading-margin textHover"> <span
										class="glyphicon glyphicon-collapse-down"></span> SOURCE CODE
										MANAGEMENT
									</a>
								</h4>
							</div>
									...
									<div class="form-group">
										...
										<div class="row ">
											<div class="col-md-12">
												...
												<div class="col-md-2">
													<label class="labelTxt marginTop8px">Repository URL
														:</label>
												</div>
												<div class="col-md-5">
												...
												<div class="col-md-1">
													<span
														class="glyphicon glyphicon-question-sign primaryGlyph marginTop8px marginLeft40px"></span>
												</div>
											</div>
										</div>
										<br>
										<div class="row ">
											<div class="col-md-12">
												<div class="col-md-2">
													<label class="labelTxt marginTop8px">Repository
														Depth :</label>
												</div>
												<div class="col-md-6">
													<select id="repositoryDepth">
														...
														class="glyphicon glyphicon-question-sign primaryGlyph marginTop8px marginLeft50px"></span>
												</div>
										...
										<div class="row ">
											<div class="col-md-12">
												<div class="col-md-2">
													<label class="labelTxt marginTop8px">Ignore
														Externals :</label>
												</div>
												<div class="col-md-6">
													<input type="checkbox" id="ignoreExternals"
														value="ignoreExternals" /> <span
														class="glyphicon glyphicon-question-sign primaryGlyph marginTop8px"></span>
												</div>
										...
										<div class="row ">
											<div class="col-md-12">
												...
												<div class="col-md-2">
													<label class="labelTxt marginTop8px">Check-out
														Strategy :</label>
												</div>
												<div class="col-md-6">
													<select id="checkStrategy" class="labelText">
														<option value="onlySvnUpdate">Use 'SVN update as
															much as possible'</option>
														<option value="checkFreshCopy">Always check out a
															fresh copy</option>
														<option value="emulateCleanCheckout">Emulate
															clean checkout by first deleting unersioned/ignored
															files, then 'svn update'</option>
														<option value="svnUpdateWithRevert">Use 'SVN
															update as much as possible', but 'svn-revert' before
															update</option>
													</select> <span
														class="glyphicon glyphicon-question-sign primaryGlyph marginTop8px marginLeft50px"></span>
												</div>
						...
						<div class="panel panel-info">
							<div class="panel-heading">
								<h4 class="panel-title panelTitle">
									<a id="menu-toggle1" data-toggle="collapse"
										href="#buildanddeploy"
										class="headingfont-size heading-margin textHover"> <span
										class="glyphicon glyphicon-collapse-down"></span> BUILD &amp;
										DEPLOY
									</a>
								</h4>
							</div>
										...
										<div class="row ">
											<div class="col-md-12">
												<div class="col-md-6">
													...
													<div class=" col-md-4">
														<label class="labelText marginTop8px">Quality Gate
															1:</label>
													</div>
													<div class="col-md-4">
														<select id="selectTest1"
															onchange="return changeSelectOption(this.value,1)">
												...
												<div class="col-md-6">
													...
													<div class="col-md-4">
														<select id="selectTest2"
															onchange="return changeSelectOption(this.value,2)">
															<option value="">--select--</option>
															<option value="codeCoverage">Code Coverage</option>
															<option value="unitTest">Unit Test</option>
														</select>
						...
						<div class="panel panel-warning">
							<div class="panel-heading">
								<h4 class="panel-title panelTitle">
									<a id="menu-toggle2" data-toggle="collapse" href="#testing"
										class="headingfont-size heading-margin textHover"> <span
										class="glyphicon glyphicon-collapse-down"></span> TESTING
									</a>
								</h4>
							</div>
												...
												<div class="col-md-6">
													...
													<div class="col-md-8">
														<select id="selectTest3">
															...
															<option value="functional_automation1">Functional
																Automation</option>
															<option value="service_automation1">Services
																Automation</option>
															<option value="ui_Automation1">UI Automation</option>
															<option value="cross_automation1">Cross Browser
																Automation</option>
															<option value="permance_testing1">Performance
																Testing</option>
															<option value="security_testing1">Security
																Testing</option>
															<option value="functional_testing1">Functional
																Testing</option>
															<option value="sentiment_analysis1">Sentiment
																Analysis</option>
															<option value="accessibility_testing1">Accessibility
																Testing</option>
														</select>
													</div>
												...
												<div class="col-md-6">
													...
													<div class="col-md-8">
														<select id="selectTest4">
															...
															<option value="functional_automation2">Functional
																Automation</option>
															<option value="service_automation2">Services
																Automation</option>
															<option value="ui_Automation2">UI Automation</option>
															<option value="cross_automation2">Cross Browser
																Automation</option>
															<option value="permance_testing2">Performance
																Testing</option>
															<option value="security_testing2">Security
																Testing</option>
															<option value="functional_testing2">Functional
																Testing</option>
															<option value="sentiment_analysis2">Sentiment
																Analysis</option>
															<option value="accessibility_testing2">Accessibility
																Testing</option>
														</select>
													</div>
												</div>
					...
					<div class="row marginTop50px">
						<div class="col-md-2 col-md-offset-5">
							<input type="submit" class="form-control btn btn-primary"
								value="Save Configuration" id="submit" />
						</div>
					</div>
				</form>
			</div>
