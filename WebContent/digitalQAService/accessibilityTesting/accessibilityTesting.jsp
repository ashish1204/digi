...
<body
	onload="changeAccordion('accessibilityTesting','digitalQAService')">
					...
					<div class="marginTop65px">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<ul>
									<li>DigiAssure platform provides complete framework to
										perform Accessibility testing of application on different
										platforms</li>
									<li>Accessibility testing ensure that the application
										being tested is usable by people with disabilities like
										hearing, color blindness, old age</li>
									<li>Framework comprises of Keyboard Accessibility, Error
										message validations, Screen Reader testing, Font
										magnification, color contrast analysis, Html Validation</li>
								</ul>
							</div>
						</div>
						...
						<div class="marginTop15px">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<ul>
										<li>Finalize usability requirements covering all
											guidelines applicable to application under test</li>
										<li>Finalize scope of accessibility testing in project
											test plan document</li>
						...
						<div class="marginTop15px">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<ol>
										<li>Select WCAG guidelines applicable to application
											under test</li>
										<li>Download utilities available on DigiAssure –
											Accessibility page</li>
										<li>Execute Accessibility scenarios on application
											screens</li>
									</ol>
								</div>
							</div>
