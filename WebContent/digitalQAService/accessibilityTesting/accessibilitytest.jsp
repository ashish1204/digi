		...
		<div class="container">
			<div class="row" style="border-bottom: 1px solid lightgrey;">
				...
				<div class="col-md-1 col-lg-4">
					<a
						href="http://10.102.22.88:8081/AccessibilityTestingPortal/demo.html"><button
							class="btn btn-primary" style="margin-top: 3px;">Help</button></a>
			...
			<ul class="nav nav-tabs">
				<li class="active"><a
					href="${pageContext.request.contextPath}/digitalQAService/accessibilityTesting/viewAllocatedBatch">
						<b><button class="btn"
								style="background-color: gray; color: #fff;">Accessibility
								Test Plan</button></b>
				</a></li>

				<li><a href="./addManualChecklisttestCase"> <b><button
								class="btn" style="background-color: gray; color: #fff;">Add
								Test Case</button></b></a></li>
				<li><a href="./batchHome"><b><button class="btn"
								style="background-color: gray; color: #fff;">Allocation</button></b></a></li>
				...
				<div class="col-sm-12 col-md-12">
					<div class="marginTop50px">
						<div class="page-header">
							...
							<h3 class="text-center" style="color: #1d7ec2">Test Set For
								Execution</h3>
							<c:if test="${not empty successMessage }">
								<br>
								<b><font color="green" size="4"> ${successMessage}</font></b>
								<br>
							</c:if>
							<c:if test="${not empty errorMessage }">
								<br>
								<b><font color="green" size="4"> ${errorMessage} </font></b>
								<br>
							</c:if>
