			...
			<c:if test="${sessionScope.rolename == 'ADMIN'}">
				<ul class="nav nav-tabs marginLeft15px">
					<li><a
						...
						class="buttonlink"> <b>Accessibility Test Plan</b></a></li>
					<li class="active"><a href="./addManualChecklisttestCase"
						class="buttonlink" style="background-color: #f3f3f3"><b><button
									class="btn accessibilityNavMenu">Add Test Case</button></b></a></li>
					<li><a class="buttonlink" href="./batchHome"><b>Allocation</b></a>
					</li>
				...
				<div class="panel panel-info">
					...
					<div class="panel-body">
						...
						<form:form class="form-horizontal"
							action="addNewAccessibilityTestCase" method="POST"
							id="addNewAccessibilityTestCase" modelAttribute="testcase"
							title="addNewAccessibilityTestCase" enctype="multipart/form-data"
							onsubmit="return validateTestCase()">

							<div class="form-group">
								<label for="run_name" class="col-sm-5 control-label">
									Test Case Name</label>
								<div class="col-sm-7">
									<form:input path="testcaseName" class="form-control txtCase"
							...
							<div class="form-group">
								<label for="testcaseDescription" class="col-sm-5 control-label">Test
							...
							<div class="form-group">
								<label for="testcasedetaildescription"
									class="col-sm-5 control-label">Test Case Detail
									Description</label>
								<div class="col-sm-7">
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									...
									</select> <font color="red"> <span id="toolError"></span></font>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									...
									</select> <font color="red"> <span id="levelError"></span></font>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									...
									</select> <font color="red"> <span id="catError"></span></font>
								</div>
								<br>
							</div>
							<div class="marginTop50px"></div>
							<input type="submit" class="btn btn-success btnCenter txtCenter" />
						</form:form>
					</div>
				</div>
