...
<body>
	...
	<div class="container">
		<h1 class="text-center addRunHeading greyTextColor">Add Manual
			Test Suite</h1>
			...
			<div class="col-sm-8 col-md-8">
				...
				<div class="panel panel-info">
					...
					<div class="panel-body">
						<div class="marginTop15px"></div>
						<form:form class="form-horizontal" action="addNewTestSuite"
							method="POST" id="addNewTestSuite" modelAttribute="batch"
							...
							<div class="form-group">
								<label for="Batch Remarks" class="col-sm-4 control-label">Batch
									Remarks</label>
								<div class="col-sm-8">
									<form:input path="remarks" class="form-control txtCase"
				...
				<font size="4" color="red"><b> <script> speak('${errorMessage}')</script>${errorMessage }
				</b></font> <font size="4" color="green"><b><script> speak('${successMessage}')</script>
						${successMessage } </b></font>
