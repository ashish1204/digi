							...
							<div class="panel-body">
								<ul>
									...
									<li>There are a set of guidelines that specify how to make
										...
										details click on <a
										href="http://10.102.22.88:8081/AccessibilityTestingPortal/demo.html">WCAG
											2.0</a> link.
									</li>
									<li>The information of key laws and documents that relate
										to web accessibility in many countries throughout the world,
										is available on <a
										href="http://10.102.22.88:8081/AccessibilityTestingPortal/index.html">Country
											Law's link.</a>
									</li>
									...
									<li>Mobile Accessibility generally refers to make Websites
										...
										accessibility and its tools click on<a
										href="http://10.102.22.88:8081/AccessibilityTestingPortal/Mobileaccessibility.html">
											Mobile Accessibility </a>link.
									</li>
							...
							<div class="panel panel-default">
								...
								<span class="marginLeft20px"> <a
									href="${pageContext.request.contextPath}/digitalQAService/accessibilityTesting/viewAllocatedBatch"><button
											class="btn btn-primary">Accessibility Test Plan</button></a> <c:if
										test="${sessionScope.rolename == 'ADMIN'}">
										<a href="./addManualChecklisttestCase"><button
												class="btn btn-primary">Add Test Case</button></a>
										<a href="./batchHome"><button class="btn btn-primary">Allocation</button></a>
									</c:if>
								</span>
								<div class="marginTop15px"></div>
							</div>
