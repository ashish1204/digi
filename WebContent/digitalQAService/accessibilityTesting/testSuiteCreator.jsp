			...
			<div class="row">
				<div class="col-sm-12 col-md-12">
					<h1 class="text-center addRunHeading greyTextColor">
						...
						<button type="button"
							class="btn btn-primary pull-right marginLeft15px"
							...
							<ul class="dropdown-menu">
								<li><a href="#"
									onClick="$('#customers2').tableExport({type:'json',escape:'false'});"><img
										src='${pageContext.request.contextPath}/styles/images/json.png'
										width="24" /> JSON</a></li>
								<li><a href="#"
									onClick="$('#customers2').tableExport({type:'json',escape:'false',ignoreColumn:'[2,3]'});"><img
										src='${pageContext.request.contextPath}/img/icons/json.png'
										width="24" /> JSON (ignoreColumn)</a></li>
								<li><a href="#"
									onClick="$('#customers2').tableExport({type:'json',escape:'true'});"><img
										src='${pageContext.request.contextPath}/styles/images/json.png'
										width="24" /> JSON (with Escape)</a></li>
								<li class="divider"></li>
								<li><a href="#"
									onClick="$('#customers2').tableExport({type:'xml',escape:'false'});"><img
										src='${pageContext.request.contextPath}/styles/images/xml.png'
										width="24" /> XML</a></li>
								<li><a href="#"
									onClick="$('#customers2').tableExport({type:'sql'});"><img
										src='${pageContext.request.contextPath}/styles/images/sql.png'
										width="24" /> SQL</a></li>
								<li class="divider"></li>
								<li><a href="#"
									onClick="$('#customers2').tableExport({type:'csv',escape:'false'});"><img
										src='${pageContext.request.contextPath}/styles/images/csv.png'
										width="24" /> CSV</a></li>
								<li><a href="#"
									onClick="$('#customers2').tableExport({type:'txt',escape:'false'});"><img
										src='${pageContext.request.contextPath}/styles/images/txt.png'
										width="24" /> TXT</a></li>
								<li class="divider"></li>
								<li><a href="#"
									onClick="$('#customers2').tableExport({type:'excel',escape:'false'});"><img
										src='${pageContext.request.contextPath}/styles/images/xls.png'
										width="24" /> XLS</a></li>
								<li><a href="#"
									onClick="$('#customers2').tableExport({type:'doc',escape:'false'});"><img
										src='${pageContext.request.contextPath}/styles/images/word.png'
										width="24" /> Word</a></li>
								<li><a href="#"
									onClick="$('#customers2').tableExport({type:'powerpoint',escape:'false'});"><img
										src='${pageContext.request.contextPath}/styles/images/ppt.png'
										width="24" /> PowerPoint</a></li>
								<li class="divider"></li>
								<li><a href="#"
									onClick="$('#customers2').tableExport({type:'png',escape:'false'});"><img
										src='${pageContext.request.contextPath}/styles/images/png.png'
										width="24" /> PNG</a></li>
								<li><a href="#"
									onClick="$('#customers2').tableExport({type:'pdf',escape:'false'});"><img
										src='${pageContext.request.contextPath}/styles/images/pdf.png'
										width="24" /> PDF</a></li>
							</ul>
						</div>
					</h1>
				...
				<div class="col-sm-12 col-md-12">
					<c:if test="${ not empty newtestcases}">
						<form:form action="addTestcasestoBatch" method="post"
									...
									<c:forEach var="testcase" items="${newtestcases}">
										...
										<tr>
											...
											<td><input type="checkbox"
												value="${testcase.testcaseid}" name="testcaseid"></td>
							...
							<input type="submit" value="Submit" name="SubmitTestcases"
								class="btn btn-success col-sm-1 col-sm-offset-5">
						</form:form>
					</c:if>
