		...
		<div class="col-md-12 col-lg-12 marginTop15px">
			<c:if test="${sessionScope.rolename == 'ADMIN'}">
				<ul class="nav nav-tabs marginLeft15px">
					<li class="active"><a class="dropdown-toggle buttonlink"
						...
						data-toggle="dropdown"><b><button
									class="btn accessibilityNavMenu">Accessibility Test
									Plan</button></b> </a></li>
					<li><a href="./addManualChecklisttestCase" class="buttonlink"><b>Add
								Test Case</b></a></li>
					<li><a class="buttonlink" href="./batchHome"><b>Allocation</b></a></li>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12 col-md-12">
				<h1 class="text-center addRunHeading greyTextColor">Test Set
					For Execution</h1>
			</div>
		</div>
	</div>
