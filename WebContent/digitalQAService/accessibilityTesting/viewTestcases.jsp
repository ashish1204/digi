...
<body>
									...
									<c:forEach var="testcase" items="${testcases}">
										...
										<tr>
											...
											<td><textarea name="comments" draggable="true"
													autofocus="autofocus" spellcheck="true" required="required">Comment </textarea></td>
										</tr>
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/js/plugins/validationengine/languages/jquery.validationEngine-en.js"></script>
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/js/plugins/validationengine/jquery.validationEngine.js"></script>
