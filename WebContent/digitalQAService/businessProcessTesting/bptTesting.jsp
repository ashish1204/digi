...
<body
	onload="changeAccordion('businessProcessTesting','digitalQAService')">
	<div>
				...
				<div class="col-sm-8 col-md-9 verticalLine">
					<div class="marginTop65px">
						<div class="page-header">
							<h1 class="greyTextColor">BPT Testing</h1>
						</div>
							...
							<div class="panel panel-default">
								...
								<!-- <span class="marginLeft20px">
									...
									<button class="btn btn-primary"
										onclick="downloadExcelTemplate()">Download Template</button>
								</span> -->
