				...
				<div class="col-sm-8 col-md-9 verticalLine">
					<div class="marginTop65px">
						<div class="page-header">
							<h1 class="greyTextColor">Cross Browser Testing - Coming
								Soon</h1>
						</div>
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<ul>
									<li>Testing Web application on multiple Browser
								...
								<div class="panel-body">
									<ul>
										<li>Setup the appropriate grid with the required browser
											configuration. DigiAssure provides the grids for Cross
											Browser Testing. If you do not have credentials. Contact Us <a
											onclick="sendMail()"> <i
												class="glyphicon glyphicon-envelope"></i>
										</a>
										</li>
										<li>Download the latest build for testing on multiple
											browsers</li>
										<li>For Cross Browser Automation , please refer to the
											Cross Browser Automation Page(Link)</li>
									</ul>
								</div>
							</div>
						</div>
								...
								<div class="panel-body">
									<ul style="list-style: none;">
										...
										<li>6. For automation testing – After step 3 Continue
											from "Continuous Delivery->Cross Browser Automation"</li>
									</ul>
								</div>
							</div>
						</div>
