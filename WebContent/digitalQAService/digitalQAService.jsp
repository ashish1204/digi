			...
			<div class="row">
				<div class="col-sm-3 paddingRight0px paddingLeft0px">
					<div class="userExperience">
						...
						<img src="../styles/images/tooltip/userExperience_tooltip.png"
							class="mobileLabImg" />
						<!--  <img src="styles/images/qa_lab_final.png" class="panelImg img-responsive"/> -->
						<div class="panelContent">
							<h3>
								<a
									href="${pageContext.request.contextPath}/digitalQAService/userExperienceTesting/userExperienceTesting.jsp">User
				...
				<div class="col-sm-3 paddingRight0px paddingLeft0px">
					<div class="mobileAppTesting">
						...
						<img src="../styles/images/tooltip/mobileApplication_tooltip.png"
							class="mobileLabImg" />
						<div class="panelContent">
							<h3>
								<a href="javascript:void(0)" class="blackTextColor"
									onclick="changeView('digitalQAService')">Mobile App Testing</a>
							</h3>
				...
				<div class="col-sm-3 paddingRight0px paddingLeft0px">
					<div class="webAppTesting">
						...
						<img src="../styles/images/tooltip/accessibility_tooltip.png"
							class="mobileLabImg" />
						<div class="panelContent">
							<h3>
								<a href="javascript:void(0)" class="blackTextColor"
									onclick="changeView('continuousDelivery')">Accessibility
									Testing</a>
							</h3>
				...
				<div class="col-sm-3 paddingRight0px paddingLeft0px">
					<div class="crossBrowserTesting">
						...
						<img
							src="../styles/images/tooltip/crossBrowserTesting_tooltip.png"
							class="mobileLabImg" />
						<div class="panelContent">
							<h3>
								<a href="javascript:void(0)" class="blackTextColor"
									onclick="changeView('dashboard')">Cross Browser Testing</a>
							</h3>
			...
			<div class="row">
				<div class="col-sm-3 paddingRight0px paddingLeft0px">
					<div class="cmsTesting">
						<div class="paddingTop50px"></div>
						<img src="../styles/images/tooltip/cms_tooltip.png"
							class="mobileLabImg" />
						<div class="panelContent">
							<h3>
								<a href="javascript:void(0)" class="blackTextColor"
									onclick="changeView('integratedQALab')"><p>Content
										Management</p>
									<p>System Testing</p></a>
							</h3>
						</div>
					</div>
				</div>
				<div class="col-sm-3 paddingRight0px paddingLeft0px">
					<div class="bptTesting">
						<div class="paddingTop50px"></div>
						<img src="../styles/images/tooltip/bpt_tooltip.png"
							class="mobileLabImg" />
						<div class="panelContent">
							<h3>
								<a href="javascript:void(0)" class="blackTextColor"
									onclick="changeView('digitalQAService')">Business Process
									Testing</a>
							</h3>
				...
				<div class="col-sm-3 paddingRight0px paddingLeft0px">
					<div class="crmTesting">
						<div class="paddingTop50px"></div>
						<img src="../styles/images/tooltip/crm_tooltip.png"
							class="mobileLabImg" />
						<div class="panelContent">
							<h3>
								<a href="javascript:void(0)" class="blackTextColor"
									onclick="changeView('continuousDelivery')"><p>Customer
										Relationship</p>
									<p>Management Testing</p></a>
							</h3>
				...
				<div class="col-sm-3 paddingRight0px paddingLeft0px">
					<div class="iotDigitalQAService">
						<div class="paddingTop50px"></div>
						<img src="../styles/images/tooltip/iot_tooltip.png"
							class="mobileLabImg" />
						<div class="panelContent">
							<h3>
								<a href="javascript:void(0)" class="blackTextColor"
									onclick="changeView('dashboard')">Internet of Things</a>
							</h3>
			...
			<div class="row">
				<div class="col-sm-3 paddingRight0px paddingLeft0px">
					<div class="digitalPaymentTesting">
						<div class="paddingTop50px"></div>
						<img
							src="../styles/images/tooltip/digitalPaymentTesting_tooltip.png"
							class="mobileLabImg" />
						<div class="panelContent">
							<h3>
								<a href="javascript:void(0)" class="blackTextColor"
									onclick="changeView('integratedQALab')">Digital Payment
									Testing</a>
							</h3>
						</div>
					</div>
				...
				<div class="col-sm-3 paddingRight0px paddingLeft0px">
					<div class="performanceTesting">
						<div class="paddingTop50px"></div>
						<img src="../styles/images/tooltip/performance_tooltip.png"
							class="mobileLabImg" />
						<div class="panelContent">
							<h3>
								<a href="javascript:void(0)" class="blackTextColor"
									onclick="changeView('digitalQAService')">Performance
									Testing</a>
							</h3>
				...
				<div class="col-sm-3 paddingRight0px paddingLeft0px">
					<div class="securityTesting">
						<div class="paddingTop50px"></div>
						<img src="../styles/images/tooltip/security_tooltip.png"
							class="mobileLabImg" />
						<div class="panelContent">
							<h3>
								<a href="javascript:void(0)" class="blackTextColor"
									onclick="changeView('continuousDelivery')">Security Testing</a>
							</h3>
				...
				<div class="col-sm-3 paddingRight0px paddingLeft0px">
					<div class="mobileCertificationTesting">
						<div class="paddingTop50px"></div>
						<img
							src="../styles/images/tooltip/mobileCertification_tooltip.png"
							class="mobileLabImg" />
						<div class="panelContent">
							<h3>
								<a href="javascript:void(0)" class="blackTextColor"
									onclick="changeView('continuousDelivery')">Mobile
									Certification Testing</a>
							</h3>
