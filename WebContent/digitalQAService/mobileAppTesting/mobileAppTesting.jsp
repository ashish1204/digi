					...
					<div class="marginTop65px">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<ul>
									<li>Testing Mobile application on multiple devices and OS
										Combinations</li>
									<li>Test your mobile native/hybrid applications remotely
										using real devices on cloud</li>
						...
						<div class="marginTop15px">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<ul>
										<li>Do you have login credentials to access the lab.
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<ul style="list-style: none;">
										...
										<li>7. Manage your devices on Cloud using the provided
											login. If you do not have the credentials please Contact us <a
											onclick="sendMail()"> <i
												class="glyphicon glyphicon-envelope"></i>
										</a>
									</ul>
