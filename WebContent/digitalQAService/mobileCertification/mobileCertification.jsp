					...
					<div class="marginTop65px">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<ul>
									<li>An interactive platform for the testers/developers to
										identify any submission guideline defects.</li>
									<li>Assures the readiness of the mobile application before
										submission.</li>
									<li>Its unique score based system helps in making a
										decision whether to submit app to store or not.</li>
									<li>Supports iOS & Android platforms.</li>
									<li>Extendable reporting capability</li>
									<li>Can be integrated with major Development and
										Configuration environments like Jenkins</li>
								</ul>
							</div>
						</div>
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<ol>
										...
										<li>Run through the auto populated checklist and select
											the tests for automation</li>
