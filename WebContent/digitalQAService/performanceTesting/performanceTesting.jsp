					...
					<div class="marginTop65px">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<ul>
									<li>Testing Web and Mobile application for Performance
										related parameters on Server and Client end</li>
									<li>Testing Applications against Benchmarks and identify
										the issues for tuning the application</li>
									<li>Capturing client side statistics such as CPU, Memory
										and Battery Utilization for Web and Mobile Applications</li>
								</ul>
							</div>
						</div>
						...
						<div class="marginTop15px">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<ul>
										<li>Setup the appropriate tool with the required
											configuration. DigiAssure provides the tools for Client and
											Server Side Performance Testing. If you do not have
											credentials. Contact Us <a onclick="sendMail()"> <i
												class="glyphicon glyphicon-envelope"></i>
										</a>
										</li>
										<li>Download and Install the latest build for Mobile/Web
											Application</li>
									</ul>
								</div>
							</div>
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<ul style="list-style: none;">
										...
										<li>3. Install your application on Desktop & Mobile
											Devices as per the requirement</li>
										<li>4. Record the script on the Performance testing tool</li>
										<li>5. Execute the scripts with required VU and Network
											Virtualization configurations</li>
