					...
					<div class="marginTop65px">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<ul>
									<li>Validation of application on multiple devices and
										platform Combinations from Security perspective</li>
									<li>Testing applications for major Security
										vulnerabilities using techniques such as Penetration testing,
										scanning etc</li>
									<li>Combination of Manual and Automated testing for E-2-E
										Security Test Execution</li>
								</ul>
							</div>
						</div>
								...
								<div class="panel-body">
									<ul>
										<li>Setup the appropriate tool with the required
											...
											Server Side Security Testing. If you do not have credentials,
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<ol>
										...
										<li>Install your application on Desktop & Mobile Devices
											as per the requirement</li>
										<li>Scan the application with the tool</li>
										<li>Go through the tool report to filter out valid
