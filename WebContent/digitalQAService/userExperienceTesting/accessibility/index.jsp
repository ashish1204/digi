							...
							<div class="panel-body">
								<ul>
									...
									<li>Mobile Accessibility generally refers to make Websites
										...
										accessibility and its tools click on<a href="#"> Mobile
						...
						<div class="marginTop15px">
							<div class="panel panel-default">
								...
								<span class="marginLeft20px"> <a
									href="${pageContext.request.contextPath}/digitalQAService/userExperienceTesting/accessibility/index.jsp"><button
											class="btn btn-primary">Accessibility Testing</button></a> <!-- <a href="./addManualChecklisttestCase?toolName=AccessibilityTesting"><button class="btn btn-primary">ADD Test case </button></a> -->
								</span>
								<div class="marginTop15px"></div>
							</div>
						</div>
