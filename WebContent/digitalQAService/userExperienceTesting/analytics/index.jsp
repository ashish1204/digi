...
<body onload="abcde()" class="newhome">
						...
						<div>
							...
							<div
								...
								<div class="integratedQALabPanel">
									<div class="panelContent">
										...
										<h4 style="color: #696969;">Sentiment BreakDown</h4>
							...
							<div
								...
								<div class="integratedQALabPanel">
									...
									<div>
										<h4 style="text-align: center; color: #696969;">Overall
											Sentiment</h4>
									</div>
 ...
 -->
				...
				<div class="col-sm-10 col-md-10 verticalLine" id="words"
					style="display: none;">
					<div class="marginTop50px">
						<div class="page-header">
							<h1>
			...
			<div id="sentimentTimeline" class="col-sm-10 col-md-10 verticalLine"
				style="display: none;">
				<div class="marginTop50px">
					<div class="page-header">
						<h1>
			...
			<div class="col-sm-10 col-md-10 verticalLine" id="topicsDiv"
				style="display: none;">
				<div class="marginTop50px">
					<div class="page-header">
						<h1>
			...
			<div class="col-sm-10 col-md-10 verticalLine" id="emotion"
				style="display: none;">
        ...
        Rating :{{rating}}
			...
			<div class="col-sm-10 col-md-10 verticalLine" id="review">
				<div class="marginTop50px">
					...
					<p>
						<b style="color: #696969;">The Ratings tool reports your
							current rating for all ratings and reviews.</b>
					</p>
