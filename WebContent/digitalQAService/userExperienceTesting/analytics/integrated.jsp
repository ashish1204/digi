...
return false;
	...
	<ul class="nav nav-tabs marginLeft15px">
		...
		<li id="screenNav"><a class="buttonlink" href="#" title="Screen"
			onclick="return hideOther('screen')"><b><button
	...
	<div class="row marginLeftRight">
		...
		<div class="col-sm-12 col-md-12 nodisplay" id="analytics">
			...
			<div id="graphDetails" class="row col-sm-12 col-md-12 marginTop15px"
				style="display: none;">
					...
					<div class="panel-body">
						...
						<center>
							<button class="btn btn-primary"
								onclick="getDeviceDetails('Android','6')">Start
								Execution</button>
						</center>
					</div>
				</div>
			</div>
			<div id="deviceList" class="row col-sm-12 col-md-12 marginTop15px"
				style="display: none;">
				<div class="panel panel-info">
					<div class="panel-heading panel-heading-custom">
					...
					<div class="panel-body">
						...
						<center>
							<a
								href="${pageContext.request.contextPath}/console/runHome?toolName=CGAF_Usability"><button
									class="btn btn-primary">Start Execution</button></a>
						</center>
					</div>
				</div>
			</div>
			...
			<div id="crashDetails" class="row col-sm-12 col-md-12 marginTop15px"
				style="display: none;">
				<div class="panel panel-info">
					<div class="panel-heading panel-heading-custom">
						<h3 class="panel-title">Crashes</h3>
						...
						<table class="table table-striped">
							...
							<tbody>
								<tr onclick="showpieGraph()">
									<td><b>java.lang.IllegalArgumentException</b><br> in
										android.location.LocationManager.checkListener</td>
									<td>New</td>
									<td><img alt=""
										src="${pageContext.request.contextPath}/styles/images/graph.png">
									<td>1</td>
									<td>Jan 7, 7:54 PM</td>
								</tr>
							</tbody>
