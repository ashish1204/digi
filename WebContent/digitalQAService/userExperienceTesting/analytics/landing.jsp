...
<body onload="abcde()">
			...
			$.ajax({
						...
						success : function(data) {
							...
							for (var i = 0; i < wordArrName.length; i++) {
								...
								document.getElementById(id).innerHTML = "<p style='font-size:15px;padding-top:30px;text-align: center;'>"+eventName+"</p>"+"<p style='font-size:15px;text-align: center;font-weight: bold;color:#000;'>"+occurances+"</p>";
							}
					...
					.ajax({
						...
						success : function(data) {
							...
							for (var i = 0; i < wordArrName.length; i++) {
								...
								document.getElementById(id).innerHTML = "<p style='font-size:19px;padding-top:10px;text-align: center;'>"+Gesture+"</p>"+"<p style='font-size:15px;text-align: center;font-weight: bold;color:#000;'>"+occurences+"</p>";
							}
	...
	<div>
		...
		<div class="col-sm-2 col-md-2 marginTop50px">
			<div class="panel-body" style="border: 15px;">
				...
				<br>
				<p>
					<a href="javascript:window.location.reload(true)">Analytics</a>
				</p>
				<p>
					<a href="session.jsp">Session</a>
				</p>
				<p>
					<a href="os.jsp">Device</a>
				</p>
		...
		<div class="col-sm-10 col-md-10 verticalLine" id="sentiment">
			<div class="marginTop50px">
				...
				<div class="row">
					<div class="col-sm-4">
						<div id="containerDU" class="col-sm-4"
							style="min-width: 400px; height: 400px; margin: 0 auto"></div>
					</div>
					<div class="col-sm-8">
						<!-- 	//event		 -->
						<div class="containerDU"
										...
										<div class="panel-heading" style="background-color: #18bcf2;">
											<h3 class="panel-title" style="color: #000;">
												<span class="glyphicon glyphicon-exclamation-sign"
													style="color: red;"></span> Error Events
											</h3>
										</div>
						...
						<div class="col-sm-10">
							<div class="panel panel-info">
								<div class="panel-heading"
									style="background-color: #18bcf2; border-style: solid; color: white;">
								...
								<div class="panel-body">
									<div class="row col-sm-12">
										<div class="col-sm-4 innerDiv">
											<div id="boxx1" class="box">
												<i class="fa fa-hand-o-up"></i>
											</div>
										</div>
										<div class="col-sm-4">
											<div id="boxx2" class="box"></div>
										</div>
										<div class="col-sm-4">
											<div id="boxx3" class="box"></div>
										</div>
