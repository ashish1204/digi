			...
			$
					.ajax({
						...
						success : function(data) {
							...
							var chart = new CanvasJS.Chart("containerSession", {
								title : {
			...
			$
					.ajax({
						...
						success : function(data) {
							...
							var chart = new CanvasJS.Chart("containerCrash", {
								title : {
									text : "Crash"
								},
								data : [ {
	...
	<div>
		...
		<div class="col-sm-2 col-md-2 marginTop50px">
			<div class="panel-body" style="border: 0px;">
				...
				<br>
				<p>
					<a href="landing.jsp" title="Sessions">Analytics</a>
				</p>
				<p>
					<a href="javascript:window.location.reload(true)">Session</a>
				</p>
				<p>
		...
		<div class="col-sm-10 col-md-10 verticalLine" id="sentiment">
			<div class="marginTop50px">
				...
				<div class="row">
					<div class="col-sm-4">
						<div id="containerSession" class="col-sm-4"
				...
				<div class="row">
					...
					<div id="containerCrash" class="col-sm-4"
						style="min-width: 400px; height: 400px; margin: 0 auto"></div>
				</div>
			</div>
		</div>
