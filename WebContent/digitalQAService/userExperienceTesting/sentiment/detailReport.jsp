...
function hideOther(divRemains){
	...
	var allDivs=['sentiment','words','sentimentTimeline','topicsDiv','review','userReviews'];
...
/* 	var navMenus = ['sentimentNav','wordsNav','sentimentTimelineNav','topicsDivNav','emotionNav','reviewNav']; */
	var navMenus = ['sentimentNav','wordsNav','sentimentTimelineNav','topicsDivNav','reviewNav'];
	...
	for(key in navMenus){
		...
		if(navMenus[key] == id){
			...
			element.childNodes[0].style.backgroundColor = '#f3f3f3';
		}
	}
}
		...
		success : function(data) {
			...
			total= negative+positive+neutral;
				...
				var value = ((positive/total)*100);
			 	value=value*2.6; 
				document.getElementById("sentimentDial").style.transform="rotate("+value+"deg)";
...
<body onload="abcde()" class="newhome">
		...
		<div class="row">
			...
			<ul class="nav nav-tabs marginLeft15px">
				...
				<li id="reviewNav"><a href="#" title="Reviews"
					onclick="return hideOther('review')"><b><button
								class="btn mobileLabMenu">Rating</button></b></a></li>

				<li id="sentimentNav"><a class="" href="#" title="Sentiment"
					id='sentimentLnk' onclick="return hideOther('sentiment')"><b><button
								class="btn mobileLabMenu">Sentiment</button></b></a></li>
				<li id="wordsNav"><a href="#" title="Cloud Testing"
					onclick="return hideOther('words')" class=""> <b><button
								class="btn mobileLabMenu">Words</button></b></a></li>
				<li id="topicsDivNav"><a href="#" title="Topics"
					onclick="return hideOther('topicsDiv')" class=""> <b><button
								class="btn mobileLabMenu">Topics</button></b></a></li>
				<!-- <li id="emotionNav"><a href="#" title="Emotion"
						onclick="return hideOther('emotion')" class=""> <b><button
									class="btn mobileLabMenu">Emotion</button></b></a></li> -->
				<li id="sentimentTimelineNav"><a href="#"
					title="Sentiment Timeline"
					onclick="return hideOther('sentimentTimeline')" class=""> <b><button
								class="btn mobileLabMenu">Sentiment Timeline</button></b>
	...
	<div class="row marginLeftRight">
		<div class="col-sm-12 col-md-12 nodisplay" id="userReviews"
			style="display: none;">
			...
			<div id="info" class="alert alert-success alert-dismissible"
	...
	<div class="row marginLeftRight">
		<div class="col-sm-12 col-md-12 nodisplay" id="review">
			...
			<p class="rating marginTop15px marginLeft15px">
				<b>The Ratings tool reports your current rating for all ratings
					and reviews.</b>
			</p>
						...
						<div class="review-rating-avg">
							...
							<div>
								<div class="review-rating-avg-stars-container">
									<span id="review-rating-avg-stars-bar"
										class="review-rating-avg-stars-bar"></span>
								</div>
							...
							<table class="rating-breakdown-table">
								<tbody>
									<tr class='rating-breakdown-row'>
										...
										<td class='breakdown-count'><span id="rating5"></span></td>
									</tr>
									<tr>
									...
									<tr class='rating-breakdown-row'>
										...
										<td class='breakdown-count'><span id="rating4"></span></td>
									</tr>
									<tr>
										<td class="padding2px"></td>
										<td class="padding2px"></td>
									...
									<tr class='rating-breakdown-row'>
										...
										<td class='breakdown-count'><span id="rating3"></span></td>
									</tr>
									<tr>
										<td class="padding2px"></td>
										<td class="padding2px"></td>
									...
									<tr class='rating-breakdown-row'>
										...
										<td class='breakdown-count'><span id="rating2"></span></td>
									</tr>
									<tr>
										<td class="padding2px"></td>
										<td class="padding2px"></td>
									...
									<tr class='rating-breakdown-row'>
										...
										<td class='breakdown-count'><span id="rating1"></span></td>
									</tr>
								</tbody>
							</table>
						</div>
	...
	<div class="row marginLeftRight">
		<div class="col-sm-12 col-md-12 nodisplay" id="sentiment">
			...
			<div
				class="col-sm-5 col-md-5 marginTop15px paddingRight0px paddingLeft0px">
			...
			<div
				class="col-sm-5 col-md-5 paddingRight0px paddingLeft0px  overall_sentiment_div">
				<div class="integratedQALabPanel">
					<div>
					...
					<div class="sentiment_div">
						...
						<div class="sentiment_div_dial" id="sentimentDial"
							style="transform: rotate(120.549deg);"></div>
						<!-- 	
								<div class="sentiment_div_dial" id="sentimentDial2" style="transform: rotate(190.549deg);">
								
								</div>
								
								
								<div class="sentiment_div_dial" id="sentimentDial3" style="transform: rotate(250.549deg);">
