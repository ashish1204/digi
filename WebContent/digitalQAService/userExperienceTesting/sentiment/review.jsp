...
return false;
	...
	<p>
		<b>The Ratings tool reports your current rating for all ratings
			and reviews. All other Appbot tools include only reviews that have a
			text comment.</b>
	</p>
	<script type="text/javascript">
					function reviews() {
						$.ajax({
									type : "GET",
									url : "${pageContext.request.contextPath}/digitalQAService/userExperienceTesting/sentimentAnalysis/reviews",
									contentType : "application/json; charset=utf-8",
									dataType : "json",
									success : function(data) {
										...
										var array = JSON.parse(JSON.stringify(data))["all_time"];
										var count = array["count"];
										var average=array["average"];
										//var  rating1 = array["average"]["breakdown"]["rating1"];
									
										$("#myCountvalue").append(count);
										$("#myAveragevalue").append(average);
										var breakdown = array["breakdown"];
										for (var i = 0; i < breakdown.length; i++) {
											rating1.push(breakdown["rating1"]);
											 alert(breakdown["rating1"]);
												alert("Rating "+rating1);
										}
			...
			<div class="review-rating-avg">
				...
				<div>
					<div class="review-rating-avg-stars-container">
						<span class="review-rating-avg-stars-bar" style="width: 70.0%"></span>
					</div>
					...
					<tbody>
						<tr class='rating-breakdown-row'>
							...
							<td class='rating-breakdown-bar'><span
								class='breakdown-bar-fill rating-breakdown-bar-overlay'
								style='width: 45.18518518518518%;'></span></td>
							<td class='breakdown-count'>244</td>
						</tr>
						<tr class='rating-breakdown-row'>
							<td class='rating-breakdown-rating-label'><i
							...
							<td class='rating-breakdown-bar'><span
								class='breakdown-bar-fill rating-breakdown-bar-overlay'
								style='width: 15.185185185185185%;'></span></td>
							<td class='breakdown-count'>82</td>
						</tr>
						<tr class='rating-breakdown-row'>
							<td class='rating-breakdown-rating-label'><i
							...
							<td class='rating-breakdown-bar'><span
								class='breakdown-bar-fill rating-breakdown-bar-overlay'
								style='width: 9.444444444444445%;'></span></td>
							<td class='breakdown-count'>51</td>
						</tr>
						<tr class='rating-breakdown-row'>
							<td class='rating-breakdown-rating-label'><i
							...
							<td class='rating-breakdown-bar'><span
								class='breakdown-bar-fill rating-breakdown-bar-overlay'
								style='width: 6.851851851851852%;'></span></td>
							<td class='breakdown-count'>37</td>
						</tr>
						<tr class='rating-breakdown-row'>
							<td class='rating-breakdown-rating-label'><i
							...
							<td class='rating-breakdown-bar'><span
								class='breakdown-bar-fill rating-breakdown-bar-overlay'
								style='width: 23.333333333333332%;'></span></td>
							<td class='breakdown-count'>126</td>
						</tr>
					</tbody>
				</table>
			</div>
