...
<body onload="changeAccordion('cloud','integratedQALabs')">
				...
				<div class="col-sm-8 col-md-9 verticalLine">
					<div class="marginTop65px">
						<div class="page-header">
							<h1 class="greyTextColor">Cloud Testing</h1>
						</div>
						...
						<div class="marginTop15px">
							<div class="panel panel-default">
								...
								<!-- <span class="marginLeft20px"> 
									...
									<a href="https://us-west-2.console.aws.amazon.com/console/home?region=us-west-2" target="_blank"><button class="btn btn-primary">Access Cloud</button></a>
								</span> -->
