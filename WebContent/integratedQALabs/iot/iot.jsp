...
<%-- <link rel="stylesheet" href="${pageContext.request.contextPath}/styles/css/extraSmallDevice.css">
<link rel="stylesheet" href="${pageContext.request.contextPath}/styles/css/smallDevice.css">
<link rel="stylesheet" href="${pageContext.request.contextPath}/styles/css/mediumDevice.css">
<link rel="stylesheet" href="${pageContext.request.contextPath}/styles/css/largeDevice.css"> --%>
...
<body onload="changeAccordion('iot','integratedQALabs')">
				...
				<div class="col-sm-8 col-md-9 verticalLine">
					<div class="marginTop65px">
						<div class="page-header">
							<h1 class="greyTextColor">Internet Of Things</h1>
						</div>
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<ul>
									<li>Testing IOT application on multiple devices and
										platform Combinations</li>
									<li>Test your IOT/Wearable applications remotely using
										real devices/ Wearables on cloud</li>
									<li>Combination of Manual and Automated testing for E-2-E
										Test Execution</li>
								</ul>
							</div>
						</div>
						...
						<div class="marginTop15px">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<ul>
										<li>Do you have login credentials to access the IOT lab.
											Contact Us <a onclick="sendMail()"> <i
												class="glyphicon glyphicon-envelope"></i>
										</a>
										</li>
										<li>Download apk/ipa from your build server path to
											install on device</li>
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<ol>
										...
										<li>For automation testing - After step 3 Continue from
											"Continuous Delivery-> Functional Testing"</li>
										<li>Manage your devices/Wearables on Cloud using the
											provided login. If you do not have the credentials. Contact
											us <a onclick="sendMail()"> <i
												class="glyphicon glyphicon-envelope"></i>
										</a>
										</li>
									</ol>
						...
						<!-- <span class="marginLeft20px"> 
							<a href='https://partners.perfectomobile.com/nexperience' target="_blank"><button class="btn btn-primary">IoT Test Lab</button></a>
						</span> -->
						<div class="marginTop15px">
							<div class="panel panel-default">
								<div class="panel-heading">
