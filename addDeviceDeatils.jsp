		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<form:form class="form-horizontal" action="addDevice" method="POST"
					id="addDevice" modelAttribute="device" title="addDevice">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<form:select path="os" class="form-control">
					...
					<div class="form-group">
						<label for="browsers" class="col-sm-3 control-label">Browsers
							Available</label>
						<div class="col-sm-8">
							<form:checkbox path="browsers" value="Chrome" />
							Chrome
					...
					<div class="form-group">
						<label for="connectivity" class="col-sm-3 control-label">Connected
							Via</label>
						<div class="col-sm-8">
							<form:select path="connectivity" class="form-control">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							...
							<form:select path="belongsto" class="form-control">
