...
<body onload="reset()">
	...
	<div class="page-content-wrap">
		...
		<div class="row">
			...
			<div class="container">
				<h1 class="text-center addRunHeading greyTextColor">Add Project</h1>
				<div class="col-sm-2 col-md-2"></div>
				<div class="col-sm-8 col-md-8">
					<div class="marginTop15px"></div>
					<div class="panel panel-info">
						<div class="panel-heading">
							<span class="panel-title"><strong>Add Project</strong></span>
						</div>
						<div class="panel-body">
							...
							<div class="marginTop15px"></div>
							<form:form class="form-horizontal" id="addProject"
								action="addProject" modelAttribute="project" method="POST">
								<div class="form-group">
									<label class="col-sm-4 control-label">Project Name* :</label>
									<div class="col-sm-8">
										<form:input class="form-control txtCase" path="projectName"
											id="projectName" placeholder="Project Name"></form:input>
									</div>
								</div>
								<div class="form-group">
