	...
	<div class="page-content-wrap">
		...
		<div class="row">
							...
							<c:if test="${sessionScope.rolename == 'ADMIN'}">
								<li class="xn-openable active"><a href="#"><span
									...
									<ul>
										...
										<li class="active"><a href="../../mobileLab/deviceSelectionMatrix/beforeAddUser"><span
			...
			<c:if test="${not empty user.userid }">
				<h1 class="text-center addRunHeading greyTextColor">Edit User</h1>
				</c:if>
				<c:if test="${empty user.userid }">
				<h1 class="text-center addRunHeading greyTextColor">Add User</h1>
				</c:if>
			...
			<div class="col-sm-8 col-sm-offset-2">
				...
				<c:if test="${not empty messageError}">
					...
					<br>
							...
							<div class="marginTop15px"></div>
							<form:form class="form-horizontal" id="addUser" action="addUser"
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<form:input class="form-control txtCase" path="firstName"
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<form:input class="form-control txtCase" path="userName"
											id="userName" placeholder="Username"></form:input>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<form:select
										name="project" id="project" path="projectid">
										<form:option value="#">SELECT PROJECT</form:option>
										<c:forEach items="${projects}" var="projects">
											<form:option value="${projects.projectid }">${projects.projectName}</form:option>
										</c:forEach>
									</form:select>
								</div>
