	...
	<div class="row">
		<li class="pull-right">
			...
			<form name="userForm" method="post" class="pull-left"
				action="../../mobileLab/deviceSelectionMatrix/uploadFileExcelDataBrowserUK"
...
<h3>Value: {{bigDesk}}</h3>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="well">
				<canvas id="bar" class="chart-bar" chart-data="dataForTableD" height="60"
	...
	<div class="row">
		<div class="col-md-6">
			<div class="well">
				<canvas id="bar" class="chart-doughnut" chart-data="dataForPieM"
					chart-labels="labelsForPieM" chart-options="options1"> </canvas>
			</div>
		</div>
		<div class="col-md-6">
