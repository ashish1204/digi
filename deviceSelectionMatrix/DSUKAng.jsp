		...
		<li class="pull-right">
			...
			<form name="userForm" method="post" class="pull-left"
				<%-- data-ng-controller='updateController' --%>
 				action="../../mobileLab/deviceSelectionMatrix/uploadFileExcelDataUK"
...
<div class="row">
	...
	<div class="row">
		...
		<div class="col-md-4">
			<div class="well">
				<canvas id="bar" class="chart-doughnut" chart-data="dataForPieIOS" height="325"
					chart-labels="labelsForPieIOS" chart-options="optionsIOS"> </canvas>
			</div>
		</div>
	</div>
	...
	<div class="row">
		...
		<div class="col-md-4">
			<div class="well"> 
				<canvas id="bar" class="chart-doughnut" chart-data="dataForPieAndroid" height="325"
					chart-labels="labelsForPieAndroid" chart-options="optionsAndroid"> </canvas>
	...
	<!-- <div class="row">
		...
		<div class="col-md-12">
			<div class="well">
				<canvas id="bar" class="chart-bar" chart-data="data" height="60"
					chart-labels="labels" chart-series="series" chart-options="options">
	...
	<div class="row">
		...
		<div class="col-md-12">
			...
			<div class="well">
				...
				<canvas id="bar" class="chart-bar" chart-data="dataOS" height="60"
					chart-labels="labelsOS" chart-series="seriesOS"
					chart-options="optionsOS"> </canvas>
	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="well">
				<canvas id="bar" class="chart-doughnut" chart-data="dataForPieAndroid"
					chart-labels="labelsForPieAndroid" chart-options="optionsAndroid"> </canvas>
			</div>
		</div>
	</div> -->
