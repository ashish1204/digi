...
<body>
 ...
 <!-- 	<li data-ng-controller="GlobalController"><a
					href="javascript:void(0)" data-ng-click="getGlobalData()">Global</a></li>
				<li data-ng-controller="USController"><a
					href="javascript:void(0)" data-ng-click="getUSData()">US</a></li>
							...
							<c:forEach items="${devList1}" var="deviceList1">
								...
								<c:if test="${deviceList1.reservation == 'false'}">
									...
									<tr>
										...
										<form name="time" action="reserveDeviceGlobal" method="post">
