...
<body>
	...
	<ul class="nav nav-tabs marginLeft15px marginTop15px">
				...
				<ul class="dropdown-menu">
					...
					<li><a
						...
						<li><a
					href="../../mobileLab/deviceSelectionMatrix/BrowserIndex.jsp#/globalMarket">Global</a></li>
				<li><a
					href="../../mobileLab/deviceSelectionMatrix/BrowserIndex.jsp#/usMarket">US</a></li>
				<li><a
					href="../../mobileLab/deviceSelectionMatrix/BrowserIndex.jsp#/ukMarket">UK</a></li>
 ...
 -->
 <li><a
					href="../../mobileLab/deviceSelectionMatrix/BrowserIndex.jsp#/global">Global</a></li>
				<li><a
					href="../../mobileLab/deviceSelectionMatrix/BrowserIndex.jsp#/us">US</a></li>
				<li><a
					href="../../mobileLab/deviceSelectionMatrix/BrowserIndex.jsp#/uk">UK</a></li>
			</ul></li>
				...
				<ul class="dropdown-menu">
					<!-- <li ><a
					 ...
					 -->
					 <li><a
					href="../../mobileLab/deviceSelectionMatrix/BrowserIndex.jsp#/userTrends">Trends</a></li>
                                 ...
                                 <c:if test="${deviceList1.reservation == 'false'}" >   
                                                ...
                                                <tr>
                                                    ...
                                                    <%--    <td align="center"><input type="checkbox"  value="${deviceList1.device_id}" id="${deviceList1.device_id}" onchange="getButton(this.id);"/></td>
                                                                ...
                                                                <td align="left">Hosted</td>
                                                                 ...
                                                                 <td align="left">Emulator</td>
                                                                                               ...
                                                                                               <form name="time" action="reserveDeviceUK" method="post">                  
                                                                                                <td><input type="number"  min="1" max="3" value="1" name="time"/></td>
                                                                                              
                                                                                                <c:if test="${deviceList1.status == 'Available'}">    
                                                                     <td align="center"><input type="submit" class="btn btn-primary" style ="background-color: #50CF4D" value="Reserve">
                                                                                  <input type="hidden" name="deviceid" value="${deviceList1.device_id}">
                                                                                  <input type="hidden" name="deviceName" value="${deviceList1.name}">
                                                                                  <input type="hidden" name="vendor" value="${deviceList1.vendor}">       
                                                                     </td>
                                                 ...
                                                 <form name="time" action="releaseDeviceUK" method="post">
                                                                                  ...
                                                                                  <c:if test="${deviceList1.reservation == 'true'}">    
                                                             <td align="center"><input type="submit" class="btn btn-primary" style ="background-color: #FDB45C" value="Release">
                                                              <input type="hidden" name="deviceid" value="${deviceList1.device_id}">
                                                                                  <input type="hidden" name="deviceName" value="${deviceList1.name}">
                                                                                  <input type="hidden" name="vendor" value="${deviceList1.vendor}">  
                                                                                  </td>
