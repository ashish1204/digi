...
<title>Digiassure| Lab Devices</title>
...
<!-- START WIDGETS -->                    
	...
	<div class="marginTop50px"></div>
		...
		<table class="table table-bordered table-striped table-actions table-hover " id="deviceTable">
			<tr>
				<th>Edit</th>
				<th>Delete</th>
				<th>Device Name</th>
			...
			<c:forEach items="${devices }" var="device">
				<tr>
					<td><a
						href="./editLabDevice?devicecatalogid=${device.devicecatalogid }">
					...
					<a
						href="./deleteLabDevice?devicecatalogid=${device.devicecatalogid }">
					...
					<td>${device.procurementdate }</td>
					<td>${device.browsers }</td>
					<td>${device.simno }</td>
					<td>${device.connectivity }</td>
					<td>${device.belongsto }</td>
