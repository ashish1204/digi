...
import com.cg.digi.rowmapper.DesktopBrowserVersionRowMapper;
import com.cg.digi.rowmapper.DeviceDetailsRowmapper;
import com.cg.digi.rowmapper.MobileBrowserVersionRowMapper;
...
import com.cg.digi.rowmapper.browserMarketshareRowMapper;
...
public class DeviceCloudDao implements IDeviceCloudDao {
	...
	public List<MobileBrowser_Version> getMobileBrowserVersionDetails() {
		...
		List<MobileBrowser_Version> mobileBrowserVersion=null;
		
		try
		{
			MobileBrowserVersionRowMapper detailsRowMapper=new MobileBrowserVersionRowMapper();
			String query="SELECT id, version, value from browser_version";
			mobileBrowserVersion=jdbcTemplate.query(query, detailsRowMapper);
		}
		catch (DataAccessException e) {
	...
	List<DesktopBrowser_Version> desktopBrowserVersion=null;
		
		try
		{
			DesktopBrowserVersionRowMapper detailsRowMapper=new DesktopBrowserVersionRowMapper();
			String query="SELECT id, version, value from browserdesktop_version";
			desktopBrowserVersion=jdbcTemplate.query(query, detailsRowMapper);
		}
		catch (DataAccessException e) {
	...
	public List<Browser_Marketshare> getBrowserData() {
		List<Browser_Marketshare> browserMarketshare = null;

		//	System.out.println("Dao");
		try {

			browserMarketshareRowMapper detailsRowMapper = new 	browserMarketshareRowMapper();
			String query = "SELECT Sr_No, Browser_Name, Month, Value from browser_marketshare";

			browserMarketshare = jdbcTemplate.query(query, detailsRowMapper);
		} catch (DataAccessException e) {
	...
	public List<Browser_Marketshare> getBrowserDataDesktop() {
		...
		try {
			...
			browserMarketshareRowMapper detailsRowMapper = new 	browserMarketshareRowMapper();
			String query = "SELECT Sr_No, Browser_Name, Month, Value from browserdesktop_marketshare";
	...
	public List<Browser_Marketshare> getBrowserDataUS() {
		...
		try {
			...
			browserMarketshareRowMapper detailsRowMapper = new 	browserMarketshareRowMapper();
			String query = "SELECT Sr_No, Browser_Name, Month, Value from browserus_marketshare";
	...
	public List<Browser_Marketshare> getBrowserDataUSDesktop() {
		...
		try {
			...
			browserMarketshareRowMapper detailsRowMapper = new 	browserMarketshareRowMapper();
			String query = "SELECT Sr_No, Browser_Name, Month, Value from browserusdesktop_marketshare";
	...
	public List<Browser_Marketshare> getBrowserDataUK() {
		...
		try {
			...
			browserMarketshareRowMapper detailsRowMapper = new 	browserMarketshareRowMapper();
			String query = "SELECT Sr_No, Browser_Name, Month, Value from browseruk_marketshare";
	...
	public List<Browser_Marketshare> getBrowserDataUKDesktop() {
		...
		try {
			...
			browserMarketshareRowMapper detailsRowMapper = new 	browserMarketshareRowMapper();
			String query = "SELECT Sr_No, Browser_Name, Month, Value from  browserukdesktop_marketshare";
