...
public class DigitalQADaoImpl implements IDigitalQADao {
		...
		try {
			...
			DigiLoggerUtils.log(
					"Data while getting testcases from database :: toolid : "
							+ toolid + ":: Values are :: " + list, LEVEL.info);
		} catch (DataAccessException e) {
			DigiLoggerUtils.log(
	...
	public List<Batch> getAllAllocatedBatches(String userid) {
		...
		String query = "SELECT b.batchid,b.batchname, b.remarks,t.toolname,b.allocatedUser,b.createdby,b.executionstatus,b.executionpercentage,u.username FROM manual_batch b, tool t, users u WHERE u.userid=b.allocatedUser and b.toolid=t.toolid and allocatedUser="
				+ userid;
		try {
