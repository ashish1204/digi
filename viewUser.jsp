		...
		$.ajax({
			...
			success : function(data) {
				...
				if (data.result == "success") {
					...
					setTimeout(function(){window.location = './viewUser'},1000);
	...
	<div class="page-content-wrap">
		...
		<div class="row">
			...
			<div class="container">
				...
				<h1 id="viewUserHeading" class="text-center addRunHeading greyTextColor">View Users</h1>
								...
								<table class="table table-striped table-bordered table-hover"
									...
									<tbody>
										<c:forEach items="${users}" var="users">
											<tr>
											<td><a href="./editUser?userid=${users.userid}"><input type="button" class="btn btn-primary"
													value="Edit"  /></a></td>
												<td><a href="./deleteUser?userid=${users.userid}"><input type="button" class="btn btn-danger"
													value="Delete" ></a></td>
